...
public class Logger {
    ...
    @AfterThrowing(pointcut = "execution(public * org.example.service.CustomerService.getAllCustomers(..))", throwing = "e")
    public void logMethod(Exception e) {
        System.out.println("[CMS] co loi xay ra: " + e.getMessage());
    }

    @AfterThrowing(pointcut = "execution(public * org.example.service.CustomerService.*(..))", throwing = "e")
